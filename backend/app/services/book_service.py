...
# Load books data
def load_books_data():
    """Load books data from CSV file or create mock data"""
    csv_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "books_with_emotions.csv")
...
def format_book_data(row: pd.Series) -> BookResponse:
    """Format a pandas Series row into a BookResponse object"""
